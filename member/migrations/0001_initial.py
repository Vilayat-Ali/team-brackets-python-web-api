...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='memberNationalitie',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nationality', models.CharField(max_length=25, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='memberRole',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nationality', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='member.membernationalitie')),
